...
export const mestreJournal = {
  ...
  pages: [
    ...
    },
    {
      ...
      content:
        "<ul>" +
        "<li><strong>Créditos não são Peças de Ouro, e não viram XP.</strong> Ver a nota abaixo — é a correção mais importante desta seção.</li>" +
        ...
        "</ul>" +
        "<p>&#9888; <strong>Correção da casa — de onde vem o XP nesta galáxia.</strong> Uma versão anterior desta seção dizia que <em>\"Créditos = Peças de Ouro (1:1) e valem XP quando conquistados\"</em>. <strong>As duas metades da frase estão erradas aqui</strong>, e a contradição com a tabela de preços era visível: a escala de Créditos foi reescalada para centenas e não fecha com preço nenhum da lista.</p>" +
        ...
        "<p><em>Se a sua mesa preferir marcos puros — \"todos sobem para o 4º\" —, funciona e é mais simples. O custo é que os conjuradores e as especializações ganham de graça o que o sistema cobra deles; em cinco aventuras é irrelevante, em vinte aparece.</em></p>",
    },
    {
