...
export const classes = [
  ...
  },
  {
    ...
    habilidades: [
      ...
      { nome: "Operar Aparatos Ofensivos e Consertar Máquinas", level: 1, desc: "<p>Opera aparatos ofensivos (redes, detonadores, grilhões), <strong>pilota naves</strong> e conserta máquinas: <strong>1-2 em 1d6</strong>.</p>", level10: "<p>A chance sobe para <strong>1-3 em 1d6</strong> — o único degrau, e só aqui: o Caçador opera aparatos, não é técnico deles.</p>" },
