...
export const classes = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    descricao:
      ...
      "<p><strong>Créditos iniciais:</strong> 2d10 × 5.000 CR.</p>" + APARATOS_NOTA,
    ...
    habilidades: [
      ...
      { nome: "Ataques Múltiplos", level: 1, desc: "<p>Adquire um <strong>segundo ataque</strong> (corpo a corpo ou à distância), realizado logo em sequência ao primeiro — antes da ação do próximo jogador na iniciativa — <strong>com a mesma Base de Ataque</strong> do primeiro.</p>" },
      reputacao(),
    ],
  },
  {
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Perde</strong> <em>Desarmar e Subjugar</em> e <em>Ataques Múltiplos</em> nos níveis iniciais; <em>Pilotar</em> é substituída por <em>Operar Aparatos Ofensivos e Consertar Máquinas</em>. É a única especialização fora do Técnico que opera <strong>aparatos ofensivos</strong>.</p>" + NOTA_SPEC,
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Perde</strong> <em>Desarmar e Subjugar</em> e <em>Ataques Múltiplos</em>, mas <strong>mantém e melhora Pilotar</strong>.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_VETERANO,
    habilidades: [
      ...
      { nome: "Mecenas", level: 3, desc: "<p>Recebe salário mensal do indivíduo ou organização que representa, equivalente a <strong>20.000 CR × seu nível</strong>.</p>" },
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    descricao:
      ...
      "<p><strong>Créditos iniciais:</strong> 2d6 × 5.000 CR.</p>",
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Perde Ataque Furtivo</strong>, mas <strong>mantém Percepção</strong>. <strong>Substituição de talentos:</strong> <em>Disfarce</em> substitui <em>Furtar</em> e <em>Obter Informação</em> substitui <em>Escalar</em> — ambos herdam os pontos do talento substituído e evoluem junto com os demais.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_OPERATIVO,
    habilidades: [
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Perde Percepção e Ataque Furtivo</strong>; ganha pilotagem e uma lista de talentos própria.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_OPERATIVO,
    habilidades: [
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Perde Percepção e Ataque Furtivo</strong> (substituído pelo Golpe Fatal).</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_OPERATIVO,
    habilidades: [
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Para de progredir</strong> em <em>Furtar</em> e em <em>Ataque Furtivo</em>.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_OPERATIVO,
    habilidades: [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    descricao:
      ...
      "<p><strong>Créditos iniciais:</strong> 1d8 × 5.000 CR.</p>" + APARATOS_NOTA,
  ...
  },
  {
    ...
    descricao:
      ...
      "<li><em>Preservação:</em> Hibernação Criogênica.</li></ul>" + NOTA_SPEC,
    equipment_restrictions: {
      ...EQ_TECNICO,
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Perde</strong> <em>Operar e Consertar Máquinas</em> e <em>Desativar Droides</em>, e seu Desconto Tecnológico vira <strong>prejuízo</strong> — inventar do zero custa mais caro do que comprar pronto.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_TECNICO,
    habilidades: [
  ...
  },
  {
    ...
    descricao:
      ...
      "<p><strong>Perde</strong> <em>Operar e Consertar Máquinas</em> e o <em>Desconto Tecnológico</em>; <em>Desativar Droides</em> é substituída por <strong>Sequestrar Droides</strong> — no lugar de <em>desligar</em> um droide, ele aprendeu a <strong>tomá-lo para si</strong>.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_TECNICO,
    habilidades: [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    descricao:
      ...
      "<p><strong>Créditos iniciais:</strong> 1d6 × 5.000 CR. <strong>Restrição:</strong> Droides não podem ser Sensíveis à Força.</p>" +
  ...
  },
  {
    ...
    high_level_hp_bonus: 1,
    restricao_alinhamentos: ["neutro"],
    flavor: "<p>O Jedi/Sith de sabre. <em>Especialização de Sensível à Força (neutro).</em></p>",
    descricao:
      ...
      "<p><strong>Troca:</strong> seu <strong>teto de Grandeza passa a ser a 6ª</strong> — os feitos lendários (7ª a 10ª) ficam para os conjuradores. A lâmina cobra o preço da profundidade.</p>" + NOTA_SPEC,
    equipment_restrictions: {
      ...EQ_SENSIVEL,
  ...
  },
  {
    ...
    high_level_hp_bonus: 1,
    restricao_alinhamentos: ["ordeiro"],
    flavor: "<p>O Jedi/Sith conjurador. <em>Especialização de Sensível à Força (ordeiro).</em></p>",
    descricao:
      "<p>Yoda, Palpatine, Dooku, a Bruxa Mãe. A Força é a arma inteira — e o corpo, só o combustível.</p>" +
      "<p>Mergulha na Força até o fundo, deixando o corpo para trás. Alcança as <strong>Grandezas mais altas</strong> antes de todos — e, quando o Foco acaba, ainda tem a carne para queimar. O canhão de vidro que escolhe a hora de trincar.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_SENSIVEL,
    habilidades: [
      ...
      { nome: "Ápice da Mente", level: 10, daily_uses: 1, desc: "<p>Uma vez por dia, você conjura um poder de <strong>uma Grandeza acima do seu teto atual</strong> ou <strong>dobra a área, a duração ou o número de alvos</strong> de um poder conhecido. Ao fazê-lo, faça <strong>JPC ou perca 1 de Constituição</strong> até o próximo descanso longo.</p><p>Se o feito for de <strong>10ª Grandeza</strong>, a perda de Constituição é <strong>permanente</strong> — e uma falha crítica significa <strong>morte por sobrecarga mental</strong>.</p>" },
      reputacao(),
    ],
  },
  {
    ...
    high_level_hp_bonus: 1,
    restricao_alinhamentos: ["caotico"],
    flavor: "<p>O equilíbrio — caçador e investigador. <em>Especialização de Sensível à Força (caótico).</em></p>",
    descricao:
      "<p>Kanan, Ezra, os Inquisidores caçando Jedi, os Guardas de Templo. A Força é ferramenta de sobrevivência.</p>" +
      "<p>Nem tanque nem canhão: o Sensível que se move pelo mundo real, farejando a Sombra e sobrevivendo a ela — caçador de Jedi renegados ou de Sith ocultos.</p>" + NOTA_SPEC,
    equipment_restrictions: EQ_SENSIVEL,
    habilidades: [
      {
