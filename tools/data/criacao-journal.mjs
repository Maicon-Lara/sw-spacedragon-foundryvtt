  ...
  pages: [
    ...
    },
    {
      ...
      content:
        ...
        "<p>Seu <strong>Nível Tecnológico</strong> sai da <strong>coluna NT</strong> da tabela da classe — no 1º nível, <strong>NT 1</strong>. Escolha <strong>três aparatos de NT 1</strong>: eles já estão prontos na ficha quando a campanha abre, e <strong>não custam Créditos</strong>. A cada nível novo você ganha <strong>mais um</strong>, de qualquer NT que já alcance.</p>" +
