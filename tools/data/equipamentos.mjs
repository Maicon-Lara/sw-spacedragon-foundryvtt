...
export const categorias = [
  ...
  },
  {
    ...
    tipo: "misc",
    itens: [
      { nome: "Cortador de Fusão", cost: "400 CR", weight_in_load: 1, desc: "<p><strong>Ofensivo, NT 1.</strong> Feixe de laser que corta lentamente superfícies finas (portas, paredes). Como arma: <strong>ataque corpo a corpo, 1d4 de dano</strong>.</p>" + ACESSO_OFENSIVO + construcao("1d10 horas") },
      ...
      { nome: "Traje Antirradiação", cost: "800 CR", weight_in_load: 1, desc: "<p><strong>Defensivo, NT 1.</strong> Traje hermético que protege de emissões radioativas. <strong>Se a vedação for comprometida</strong>, o usuário fica exposto — e não dá para reparar antes que isso aconteça.</p>" + ACESSO_DEFENSIVO + construcao("1d10 horas") },
      ...
      { nome: "Visor Térmico", cost: "200 CR", desc: "<p><strong>Utilitário, NT 1.</strong> Mostra a assinatura térmica dos objetos. A visão imperfeita dá <strong>−4 nos ataques</strong>. Pode virar binóculo pelo dobro do custo e do tempo.</p>" + ACESSO_UTILITARIO + construcao("1d6 horas") },
      { nome: "Visor Noturno", cost: "400 CR", desc: "<p><strong>Utilitário, NT 1.</strong> Enxergar normalmente na <strong>escuridão total</strong>, sem penalidade, até <strong>15 m</strong>. Versão binóculo (dobro do custo e do tempo) enxerga até <strong>45 m</strong>.</p>" + ACESSO_UTILITARIO + construcao("1d6 horas") },
      { nome: "Medidor de Radiação", cost: "700 CR", desc: "<p><strong>Utilitário, NT 1.</strong> Detecta os níveis de radiação de um local, dizendo se é seguro permanecer sem traje.</p>" + ACESSO_UTILITARIO + construcao("1d4 horas") },
      { nome: "Projetor Holográfico", cost: "400 CR", desc: "<p><strong>Utilitário, NT 2.</strong> Cria uma representação audiovisual tridimensional de qualquer ser ou objeto previamente gravado. Seres de inteligência humana ou superior <strong>distinguem facilmente</strong> da realidade; espécies menos desenvolvidas podem ser enganadas.</p>" + ACESSO_UTILITARIO + construcao("1d4 dias") },
      { nome: "Baliza Rastreadora", cost: "600 CR", desc: "<p><strong>Utilitário, NT 2.</strong> Transmissor acoplável a qualquer superfície; transmite a localização em tempo real para um comunicador de vídeo. Só funciona se o alvo estiver <strong>no mesmo planeta</strong> (ou a distância similar no espaço).</p>" + ACESSO_UTILITARIO + construcao("1d4 horas") },
      { nome: "Broca de Mineração Portátil", cost: "1.400 CR", weight_in_load: 2, desc: "<p><strong>Utilitário, NT 2.</strong> Escava rocha e minerais ou força entrada por portas e paredes. <strong>Vida útil de 6 horas</strong> de uso contínuo, depois precisa de reparos.</p>" + ACESSO_UTILITARIO + construcao("1d6 horas") },
      { nome: "Cilindro de Dados", cost: "1.400 CR", desc: "<p><strong>Utilitário, NT 2.</strong> Do tamanho de uma caneta, transporta dados científicos entre laboratórios. Capacidade virtualmente ilimitada; leitura fácil em qualquer laboratório.</p>" + ACESSO_UTILITARIO + construcao("1d4 horas") },
      { nome: "Bloqueador de Sinal (jammer)", cost: "1.600 CR", desc: "<p><strong>Utilitário, NT 2.</strong> Bloqueia transmissão e recepção de rádio num raio de <strong>50 m</strong>. Nenhum transmissor ou controle remoto funciona até que o aparato seja desativado.</p>" + ACESSO_UTILITARIO + construcao("1d6 horas") },
      { nome: "Holocâmera Remota", cost: "1.600 CR", desc: "<p><strong>Utilitário, NT 2.</strong> Câmera minúscula que transmite imagem e som para um comunicador de vídeo, a até <strong>5 km</strong>. Sujeita a interferência.</p>" + ACESSO_UTILITARIO + construcao("1d4 dias") },
