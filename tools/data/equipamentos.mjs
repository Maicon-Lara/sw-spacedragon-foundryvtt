...
const REGRA_NT =
  ...
  + "<p><em>Por que o NT 3 tem divisor próprio:</em> ele é a costura entre as duas escalas. Com ÷100 direto, o NT 2 terminava em 160 CR e o NT 3 começava em 600 — um salto de 10× num único degrau. Com ÷300 a sequência fica contínua (160 → 200 → 800) e <strong>nenhum degrau salta mais que 2×</strong>.</p>"
  + "<p><em>Por que o básico é barato:</em> um Técnico de 1º nível tem 1d8 × 50 CR e a classe exige que ele <strong>comece o jogo com aparatos prontos</strong>. A ÷100 ele mal compraria um, e a habilidade-assinatura da classe nasceria morta.</p>";
