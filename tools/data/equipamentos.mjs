...
export const categorias = [
  ...
  },
  {
    ...
    itens: [
      ...
      { nome: "Respirador Aquático", cost: "2.500 CR", desc: "<p><strong>Utilitário, NT 3.</strong> Respirar normalmente embaixo d'água, com ou sem capacete. <strong>Autonomia indefinida</strong> na água; menos efetivo em outros líquidos.</p>" + ACESSO_UTILITARIO + construcao("1d4 horas") },
